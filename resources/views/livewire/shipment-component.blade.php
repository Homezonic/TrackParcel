            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotification)
                    <div wire:model="showSuccesNotification"
                        ...
                        <span
                            class="alert-text text-white">{{ __('tpl.shipmentadd') }}</span>
                        <button wire:click="$set('showSuccesNotification', false)" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                @endif

                <form wire:submit.prevent="createShipment" role="form text-left">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="@error('package_weight')border border-danger rounded-3 @enderror">
                                    <input wire:model="package_weight" class="form-control" type="number" step="any" placeholder="1.8" id="package_weight">
                                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{__('tpl.s18') }}</button>
                    </div>
                </form>
